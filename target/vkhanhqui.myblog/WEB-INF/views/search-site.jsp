    ...
    <div class="content clearfix">
        ...
        <div class="main-content">
            ...
            <div class="pagination">
                    ...
                    <c:forEach var="i" items="${pagedListNumber.pageList}">
                        <c:choose>
                            <c:when test="${i==currentPage}">
                                <li><a class="active"
                                       href="/keywords/${keywords}/${i}">${i}</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a
                                        href="/keywords/${keywords}/${i}">${i}</a></li>
                ...
                <a
                        href="/keywords/${keywords}/${pagedListPost.pageCount}"
            ...
            <div class="section popular">
                ...
                <c:forEach var="one" items="${mostViewed}">
                    <div class="post clearfix">
                        ...
                        <a href="/single/${one.id}" class="title"><h4>${one.description}</h4></a>
                    </div>
                </c:forEach>
            </div>
