		...
		<div class="content clearfix">
			...
			<div class="main-content">
				...
				<div class="pagination">
					<a href="/vkhanhqui_myblog_war/categories/${nameOfCategory}/1"
						class="btn-paginate prev"><i class="fa fa-chevron-left"><i
							class="fa fa-chevron-left"></i></i></a> <a
						href="/vkhanhqui_myblog_war/categories/${nameOfCategory}/${currentPage-3}"
					...
					<a
						href="/vkhanhqui_myblog_war/categories/${nameOfCategory}/${pagedListPost.pageCount}"
