    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active"><a href="/vkhanhqui_myblog_war/"
    ...
    <div class="container" id="paging-div1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-4 d-flex">
                                <div class="text w-100 pl-md-3">
                                    <span class="subheading">${onePost.category.name}</span>
                                    <h2>
                                    ...
                                    <div class="meta">
                                        <p class="mb-0">
                                            ...
                                            | <a href="detail/${onePost.id}">${onePost.reading}</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row mt-5">
            <div class="col text-center">
                <div class="block-27">
                    <ul>
                        <li><a href="/vkhanhqui_myblog_war/1">&lt;&lt;</a></li>
                        <li><a href="/vkhanhqui_myblog_war/${currentPage-3}">&lt;</a></li>
                        <%--                        --%>
                        <c:forEach var="i" items="${pagedListNumber.pageList}">
                            <c:choose>
                                <c:when test="${i==currentPage}">
                                    <li class="active"><a href="/vkhanhqui_myblog_war/${i}">${i}</a>
                                    </li>
                                </c:when>
                                <c:otherwise>
                        ...
                        <%--             /           --%>
                        <li><a href="/vkhanhqui_myblog_war/${currentPage+3}">&gt;</a></li>
                        <li><a href="/vkhanhqui_myblog_war/${pagedListPost.pageCount}">&gt;&gt;</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<script src="<c:url value="/resources/homePage/js/aos.js"/>"></script>
<script
        src="<c:url value="/resources/homePage/js/jquery.animateNumber.min.js"/>"></script>
<script src="<c:url value="/resources/homePage/js/scrollax.min.js"/>"></script>
<script src="<c:url value="/resources/homePage/js/main.js"/>"></script>
<script src="<c:url value="/resources/homePage/js/backtotop.js"/>"></script>
<script src="<c:url value="/resources/homePage/js/smoothscroll.js"/>"></script>
</body>
</html>
