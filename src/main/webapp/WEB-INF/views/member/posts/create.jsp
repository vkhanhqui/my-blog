...
<body>
	...
	<div class="admin-wrapper">
		<div class="left-sidebar">
			<ul>
				<li><a href="/vkhanhqui_myblog_war/member/posts/index">Manage
						Posts</a></li>
			</ul>
		</div>
		...
		<div class="admin-content">
			<div class="button-group">
				<a href="/vkhanhqui_myblog_war/member/posts/create"
					class="btn btn-big">Add Post</a> <a
					href="/vkhanhqui_myblog_war/member/posts/index" class="btn btn-big">Manage
					Posts</a>
			</div>
			...
			<div class="content">
				...
				${message}
				<form:form action="/vkhanhqui_myblog_war/admin/posts/create"
					...
					<div>
						...
						<form:input type="file" name="thumbnail" accept="image/*"
							path="thumbnail" />
					</div>
					<div>
