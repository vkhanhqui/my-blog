...
<div class="admin-wrapper">
    <div class="left-sidebar">
        <ul>
            <li><a href="/vkhanhqui_myblog_war_exploded/admin/posts/index">Manage Posts</a></li>
            <li><a href="/vkhanhqui_myblog_war_exploded/admin/users/index">Manage Users</a></li>
        </ul>
    </div>

    <div class="admin-content">
        <div class="button-group">
				<a href="/vkhanhqui_myblog_war_exploded/admin/users/create" class="btn btn-big">Add User</a> <a
					href="/vkhanhqui_myblog_war_exploded/admin/users/index" class="btn btn-big">Manage Users</a>
			</div>

        <div class="content">
            <h2 class="page-title">Alter User</h2>
            ${message}
            <form action="/vkhanhqui_myblog_war_exploded/admin/users/alter/${userId}" method="post">
                <div>
                    <label>Email</label>
