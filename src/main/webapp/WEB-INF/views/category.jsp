    ...
    <div class="container" id="paging-div1">
                        ...
                        <div class="text p-4 float-right d-block">
                            <div class="topper d-flex align-items-center">
                                <div class="one py-2 pl-3 pr-1 align-self-stretch">
                                    <span class="day">${onePost.date.day}</span>
                                </div>
                                <div class="two pl-0 pr-3 py-2 align-self-stretch">
                                    <span class="yr">${onePost.date.year}</span> <span
                                        class="mos">${onePost.date.month}</span>
                                </div>
                            </div>
        ...
        <div class="row mt-5">
            <div class="col text-center">
                <div class="block-27">
                    <ul>
                    	<li><a href="/vkhanhqui.myblog/categories/1">&lt;&lt;</a></li>
                        <li><a href="/vkhanhqui.myblog/categories/${currentPage-3}">&lt;</a></li>
                        <%--                        --%>
                        <c:forEach var="i" items="${pagedListNumber.pageList}">
                            <c:choose>
                                <c:when test="${i==currentPage}">
                                    <li class="active">
                                        <a href="/vkhanhqui.myblog/categories/${i}">${i}</a>
                                    </li>
                                </c:when>
                                <c:otherwise>
                                    <li><a
                                            href="/vkhanhqui.myblog/categories/${i}">${i}</a></li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                        <%--             /           --%>
                        <li><a href="/vkhanhqui.myblog/categories/${currentPage+3}">&gt;</a></li>
                        <li><a href="/vkhanhqui.myblog/categories/${nameCategory}/${pagedListPost.pageCount}">&gt;&gt;</a></li>
                    </ul>
                </div>
            </div>
        </div>
