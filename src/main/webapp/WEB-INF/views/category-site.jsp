    ...
    <div class="content clearfix">
        ...
        <div class="main-content">
            ...
            <div class="pagination">
                <a href="/vkhanhqui_myblog_war/categories/${nameOfCategory}/1" class="btn-paginate prev"><i
                        class="fa fa-chevron-left"><i class="fa fa-chevron-left"></i></i></a>
                <a href="/vkhanhqui_myblog_war/categories/${nameOfCategory}/${currentPage-3}" class="btn-paginate prev"><i
                    ...
                    <c:forEach var="i" items="${pagedListNumber.pageList}">
                        <c:choose>
                            <c:when test="${i==currentPage}">
                                <li><a class="active"
                                       href="/vkhanhqui_myblog_war/categories/${nameOfCategory}/${i}">${i}</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="/vkhanhqui_myblog_war/categories/${nameOfCategory}/${i}">${i}</a></li>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                    <%--             /           --%>
                </ul>
                <a href="/vkhanhqui_myblog_war/categories/${nameOfCategory}/${currentPage+3}"
                   class=" btn-paginate prev"><i
                        class="fa fa-chevron-right"></i></a>
                <a href="/vkhanhqui_myblog_war/categories/${nameOfCategory}/${pagedListPost.pageCount}"
                   class="btn-paginate prev"><i class="fa fa-chevron-right"><i class="fa fa-chevron-right"></i></i></a>
            </div>
            <%--				--%>
            <c:forEach var="one" items="${pagedListPost.pageList}">
                <div class="post">
                    ...
                    <div class="post-preview">
                        ...
                        <a href="/vkhanhqui_myblog_war/single/${one.id}" class="btn read-more">Read More</a>
                    </div>
                </div>
            </c:forEach>
            <%--		/		--%>
