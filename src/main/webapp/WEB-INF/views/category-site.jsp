    ...
    <div class="content clearfix">
        ...
        <div class="main-content">
            ...
            <div class="pagination">
                <a href="/vkhanhqui_myblog_war_exploded/categories/${category_id}/1"
                   class="btn-paginate prev"><i class="fa fa-chevron-left"><i
                        class="fa fa-chevron-left"></i></i></a> <a
                    href="/vkhanhqui_myblog_war_exploded/categories/${category_id}/${currentPage-3}"
                    ...
                    <c:forEach var="i" items="${pagedListNumber.pageList}">
                        <c:choose>
                            <c:when test="${i==currentPage}">
                                <li><a class="active"
                                       href="/vkhanhqui_myblog_war_exploded/categories/${category_id}/${i}">${i}</a>
                                </li>
                            </c:when>
                            <c:otherwise>
                                <li><a
                ...
                <a
                        href="/vkhanhqui_myblog_war_exploded/categories/${category_id}/${pagedListPost.pageCount}"
