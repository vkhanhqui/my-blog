		...
		<div class="container">
			<div
				...
				<div class="col-md-12 ftco-animate">
					<h1 class="mb-4 mb-md-0">detail</h1>
					<div class="row">
						<div class="col-md-7">
							<div class="text">
								<div class="mouse">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 ftco-animate">
					<p class="mb-5">
						<img
							src="${pageContext.request.contextPath}/resources/homePage/images/image_1.jpg"
							alt="" class="img-fluid">
					</p>
					...
					<p class="mb-5">
						<img
							src="${pageContext.request.contextPath}/resources/homePage/images/image_2.jpg"
							alt="" class="img-fluid">
					</p>
					...
					<div class="about-author d-flex p-4 bg-light">
						<div class="bio mr-5">
							<img
								src="${pageContext.request.contextPath}/resources/homePage/images/person_1.jpg"
					...
					<div class="sidebar-box ftco-animate">
						...
						<div class="tagcloud">
							<a href="#" class="tag-cloud-link">cat</a> <a href="#"
								class="tag-cloud-link">abstract</a> <a href="#"
								class="tag-cloud-link">people</a> <a href="#"
								class="tag-cloud-link">person</a> <a href="#"
								class="tag-cloud-link">model</a> <a href="#"
