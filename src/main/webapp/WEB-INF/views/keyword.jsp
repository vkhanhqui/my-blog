    ...
    <div class="container" id="paging-div1">
        ...
        <div class="row mt-5">
            <div class="col text-center">
                <div class="block-27">
                    <ul>
                        <li><a href="/vkhanhqui_myblog_war/keywords/${keyword}/1">&lt;&lt;</a></li>
                        <li><a href="/vkhanhqui_myblog_war/keywords/${keyword}/${currentPage-3}">&lt;</a></li>
                        <%--                        --%>
                        <c:forEach var="i" items="${pagedListNumber.pageList}">
                            <c:choose>
                                <c:when test="${i==currentPage}">
                                    <li class="active">
                                        <a href="/vkhanhqui_myblog_war/keywords/${keyword}/${i}">${i}</a>
                                    </li>
                                </c:when>
                                <c:otherwise>
                                    <li><a
                        ...
                        <%--             /           --%>
                        <li><a href="/vkhanhqui_myblog_war/keywords/${keyword}/${currentPage+3}">&gt;</a></li>
                        <li><a href="/vkhanhqui_myblog_war/keywords/${keyword}/${pagedListPost.pageCount}">&gt;&gt;</a></li>
                    </ul>
                </div>
            </div>
        </div>
