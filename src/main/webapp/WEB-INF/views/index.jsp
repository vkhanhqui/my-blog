...
<head>
    ...
    <meta property="og:url"
          content="https://vkhanhqui-myblog.herokuapp.com/"/>
    <meta property="og:type" content="article"/>
    <meta property="og:title" content="Click here to see more"/>
    <meta property="og:image"
          content="<c:url value="/resources/images/thumbnail.jpg" />"/>
    <!-- icon -->
    ...
    <div class="content clearfix">
        ...
        <div class="main-content">
            ...
            <div class="pagination">
                    ...
                    <c:forEach var="i" items="${pagedListNumber.pageList}">
                        <c:choose>
                            <c:when test="${i==currentPage}">
                                <li><a class="active" href="/${i}">${i}</a></li>
                            </c:when>
                            <c:otherwise>
                                <li><a href="/${i}">${i}</a></li>
                            </c:otherwise>
                ...
                <a href="/${pagedListPost.pageCount}"
            ...
            <div class="section popular">
                ...
                <c:forEach var="one" items="${mostViewed}">
                    <div class="post clearfix">
                        ...
                        </a> <a href="/single/${one.id}" class="title"><h4>${one.description}</h4>
                    </a>
                    </div>
                </c:forEach>
            </div>
